<?php
    /**
     * Template Name: One Brand - International
     *
     * @package WordPress
     * @subpackage cyh
      * 
                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            ...
                            <?php if ($icon_selector == 'TV') { ?>
                            <a  target="_blank" href=<?php echo the_sub_field('more_info_button_link') ?>><?php echo the_sub_field('campaign_button_verbiage') ?>
                            </a>
                            <?php } ?>
                        </div>
