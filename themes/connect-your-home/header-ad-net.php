 ...
 <header class="page-head">
            <div class="row">
                ...
                if(get_field('edp_brand_phone')){ ?>
                    <a data-invoca-campaign-id="<?php echo get_field('campaign_id'); ?>" href="tel:<?php echo get_field('edp_brand_phone', 'option');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - YP');" class="phone-number btn btn-lg btn-success"><i class="glyphicon glyphicon-earphone"></i> 
                    <?php
                        echo get_field('edp_brand_phone');
                }elseif(get_field('phone_number_one_brand')){ ?><a data-invoca-campaign-id="<?php echo get_field('campaign_id'); ?>" href="tel:<?php echo get_field('phone_number_one_brand');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - YP');" class="phone-number btn btn-lg btn-success"><i class="glyphicon glyphicon-earphone"></i> 
                <?php
                        echo get_field('phone_number_one_brand');
                }elseif(get_field('brand_phone_number')){ ?><a data-invoca-campaign-id="<?php echo get_field('campaign_id'); ?>" href="tel:<?php echo get_field('brand_phone_number');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - YP');" class="phone-number btn btn-lg btn-success"><i class="glyphicon glyphicon-earphone"></i> 
                <?php
                        echo get_field('brand_phone_number');
                }else{ ?><a data-invoca-campaign-id="<?php echo get_field('campaign_id'); ?>" href="tel:<?php echo get_field('home_phone_number', 'option');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - YP');" class="phone-number btn btn-lg btn-success"><i class="glyphicon glyphicon-earphone"></i> 
                <?php
