...
.brand-grid > .brand-cta-row:first-child .brand-cta {
...
<header>
        <div class="row">
            ...
            <div class="col-xs-7 col-xs-offset-1">
                <div class="phone"><span class="phone-lbl">Order By Phone:</span><span class="phone-no">
                
<!-- dynamic phone number via url params -->                <?php
                if(get_field('edp_brand_phone')){ ?>
                    <a href="tel:<?php echo get_field('edp_brand_phone');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - EDP');" class="phone-number edp-number">
                    <?php
                        echo get_field('edp_brand_phone');
                }elseif(get_field('phone_number_one_brand')){ ?><a href="tel:<?php echo get_field('phone_number_one_brand');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - EDP');" class="phone-number edp-number">
                <?php
                        echo get_field('phone_number_one_brand');
                }else{ ?><a href="tel:<?php echo get_field('home_phone_number', 'option');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall - Header - EDP');" class="phone-number edp-number">
                <?php
