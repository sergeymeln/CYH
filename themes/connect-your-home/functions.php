...
//        }
        ...
        wp_enqueue_style( 'style-name', get_template_directory_uri() .'/css/marketing.css' );
        wp_enqueue_script( 'script-name', get_template_directory_uri() . '/javascripts/marketing.js', array( 'jquery' ), '1.0.0', true );
