...
?>
    <div class="mbottom10">
        <div class="address-search-widget" data-widgetid="<?php echo $addressSearch->WidgetId ?>">
            <div id="address-widget-message" class="alert alert-warning text-center hide" role="alert">
                Please select an address from the autocomplete dropdown in order to find deals near you!
            </div>
            <div class="row" data-prepopulate="false">
                <div class="col-md-offset-1 col-md-7 mtop10">
                    <div class="row">
                ...
                <div class="col-md-4 text-center mtop10">
                    <a href="<?php echo $addressSearch->GetSearchLink() ?>" disabled
                       class="btn btn-outline search-button-header address-submit-btn"
                       title="Please select an address from the autocomplete dropdown in order to find deals near you!">
                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Click To See Your Offers
                    </a>
                </div>
            </div>
        </div>
