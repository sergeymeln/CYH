...
/**
 * This class stands for UpdateAccountOutput Models
 * @subpackage Structs
 */
class UpdateAccountOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $MembershipID;
    /**
     * Constructor method for UpdateAccountOutput
     * @uses UpdateAccountOutput::setStatus()
     * @uses UpdateAccountOutput::setClientMemberID()
     * @uses UpdateAccountOutput::setMembershipID()
     * @param string $status
     ...
     * Set Status value
     * @param string $status
     * @return \CYH\Ocenture\Models\UpdateAccountOutput
     */
