...
/**
 * This class stands for RemoteSupportActivityInput Models
 * @subpackage Structs
 */
class RemoteSupportActivityInput extends AbstractStructBase
{
    /**
     * The ClientID
     * @var int
    ...
    public $MembershipID;
    /**
     * Constructor method for RemoteSupportActivityInput
     * @uses RemoteSupportActivityInput::setClientID()
     * @uses RemoteSupportActivityInput::setClientMemberID()
     * @uses RemoteSupportActivityInput::setMembershipID()
     * @param int $clientID
     ...
     * Set ClientID value
     * @param int $clientID
     * @return \CYH\Ocenture\Models\RemoteSupportActivityInput
     */
