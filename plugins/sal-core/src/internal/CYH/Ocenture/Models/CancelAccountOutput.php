...
/**
 * This class stands for CancelAccountOutput Models
 * @subpackage Structs
 */
class CancelAccountOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $MembershipID;
    /**
     * Constructor method for CancelAccountOutput
     * @uses CancelAccountOutput::setStatus()
     * @uses CancelAccountOutput::setClientMemberID()
     * @uses CancelAccountOutput::setMembershipID()
     * @param string $status
