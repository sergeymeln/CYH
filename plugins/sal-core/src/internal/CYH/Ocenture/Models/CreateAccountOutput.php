...
/**
 * This class stands for CreateAccountOutput Models
 * @subpackage Structs
 */
class CreateAccountOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $ProductCode;
    /**
     * Constructor method for CreateAccountOutput
     * @uses CreateAccountOutput::setStatus()
     * @uses CreateAccountOutput::setClientMemberID()
     * @uses CreateAccountOutput::setMembershipID()
     * @uses CreateAccountOutput::setProductCode()
     * @param string $status
     ...
     * Set Status value
     * @param string $status
     * @return \CYH\Ocenture\Models\CreateAccountOutput
     */
