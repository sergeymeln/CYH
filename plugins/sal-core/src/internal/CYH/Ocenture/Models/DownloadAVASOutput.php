...
/**
 * This class stands for DownloadAVASOutput Models
 * @subpackage Structs
 */
class DownloadAVASOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $MembershipID;
    /**
     * Constructor method for DownloadAVASOutput
     * @uses DownloadAVASOutput::setStatus()
     * @uses DownloadAVASOutput::setClientMemberID()
     * @uses DownloadAVASOutput::setMembershipID()
     * @param string $status
