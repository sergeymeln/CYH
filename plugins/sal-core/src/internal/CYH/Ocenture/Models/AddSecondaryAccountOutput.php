...
/**
 * This class stands for AddSecondaryAccountOutput Models
 * @subpackage Structs
 */
class AddSecondaryAccountOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $ProductCode;
    /**
     * Constructor method for AddSecondaryAccountOutput
     * @uses AddSecondaryAccountOutput::setStatus()
     * @uses AddSecondaryAccountOutput::setClientMemberID()
     * @uses AddSecondaryAccountOutput::setMembershipID()
     * @uses AddSecondaryAccountOutput::setProductCode()
     * @param string $status
