...
/**
 * This class stands for ReactivateAccountOutput Models
 * @subpackage Structs
 */
class ReactivateAccountOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $MembershipID;
    /**
     * Constructor method for ReactivateAccountOutput
     * @uses ReactivateAccountOutput::setStatus()
     * @uses ReactivateAccountOutput::setClientMemberID()
     * @uses ReactivateAccountOutput::setMembershipID()
     * @param string $status
