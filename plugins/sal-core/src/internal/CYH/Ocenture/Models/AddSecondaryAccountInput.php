...
/**
 * This class stands for AddSecondaryAccountInput Models
 * @subpackage Structs
 */
class AddSecondaryAccountInput extends AbstractStructBase
{
    /**
     * The ClientMemberID
     * @var string
    ...
    public $CreatedBy;
    /**
     * Constructor method for AddSecondaryAccountInput
     * @uses AddSecondaryAccountInput::setClientMemberID()
     * @uses AddSecondaryAccountInput::setMembershipID()
     * @uses AddSecondaryAccountInput::setProductCode()
     * @uses AddSecondaryAccountInput::setPrefix()
     * @uses AddSecondaryAccountInput::setFirstName()
     * @uses AddSecondaryAccountInput::setLastName()
     * @uses AddSecondaryAccountInput::setMiddleInitial()
     * @uses AddSecondaryAccountInput::setSuffix()
     * @uses AddSecondaryAccountInput::setCompany()
     * @uses AddSecondaryAccountInput::setAddress()
     * @uses AddSecondaryAccountInput::setAddress2()
     * @uses AddSecondaryAccountInput::setCity()
     * @uses AddSecondaryAccountInput::setState()
     * @uses AddSecondaryAccountInput::setZipcode()
     * @uses AddSecondaryAccountInput::setCountry()
     * @uses AddSecondaryAccountInput::setPhone()
     * @uses AddSecondaryAccountInput::setEmail()
     * @uses AddSecondaryAccountInput::setUsername()
     * @uses AddSecondaryAccountInput::setPassword()
     * @uses AddSecondaryAccountInput::setSecurityQuestion()
     * @uses AddSecondaryAccountInput::setSecurityAnswer()
     * @uses AddSecondaryAccountInput::setSSN()
     * @uses AddSecondaryAccountInput::setDOB()
     * @uses AddSecondaryAccountInput::setGender()
     * @uses AddSecondaryAccountInput::setAccountType()
     * @uses AddSecondaryAccountInput::setRepID()
     * @uses AddSecondaryAccountInput::setResellerID()
     * @uses AddSecondaryAccountInput::setPlanCode()
     * @uses AddSecondaryAccountInput::setContactId()
     * @uses AddSecondaryAccountInput::setOpportunityId()
     * @uses AddSecondaryAccountInput::setCampaignId()
     * @uses AddSecondaryAccountInput::setAgentId()
     * @uses AddSecondaryAccountInput::setCreatedBy()
     ...
     */
    public function __construct($clientMemberID = null, $membershipID = null, $productCode = null, $prefix = null, $firstName = null, $lastName = null, $middleInitial = null, $suffix = null, $company = null, $address = null, $address2 = null, $city = null, $state = null, $zipcode = null, $country = null, $phone = null, $email = null, $username = null, $password = null, $securityQuestion = null, $securityAnswer = null, $sSN = null, $dOB = null, $gender = null, $accountType = null, $repID = null, $resellerID = null, $planCode = null, $contactId = null, $opportunityId = null, $campaignId = null, $agentId = null, $createdBy = null)
    {
        $this
     ...
     * @param string $clientMemberID
     * @return \CYH\Ocenture\Models\AddSecondaryAccountInput
     */
