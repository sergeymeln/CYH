...
/**
 * This class stands for CreateRetailAccountOutput Models
 * @subpackage Structs
 */
class CreateRetailAccountOutput extends AbstractStructBase
{
    /**
     * The Status
     * @var string
    ...
    public $ProductCode;
    /**
     * Constructor method for CreateRetailAccountOutput
     * @uses CreateRetailAccountOutput::setStatus()
     * @uses CreateRetailAccountOutput::setClientMemberID()
     * @uses CreateRetailAccountOutput::setMembershipID()
     * @uses CreateRetailAccountOutput::setProductCode()
     * @param string $status
     ...
     * Set Status value
     * @param string $status
     * @return \CYH\Ocenture\Models\CreateRetailAccountOutput
     */
