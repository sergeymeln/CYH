...
/**
 * This class stands for CancelAccountInput Models
 * @subpackage Structs
 */
class CancelAccountInput extends AbstractStructBase
{
    /**
     * The ClientID
     * @var int
    ...
    public $ModifiedBy;
    /**
     * Constructor method for CancelAccountInput
     * @uses CancelAccountInput::setClientID()
     * @uses CancelAccountInput::setClientMemberID()
     * @uses CancelAccountInput::setMembershipID()
     * @uses CancelAccountInput::setModifiedBy()
     * @param int $clientID
     ...
     * Set ClientID value
     * @param int $clientID
     * @return \CYH\Ocenture\Models\CancelAccountInput
     */
