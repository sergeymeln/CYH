<?php
/* @var $topOffer \CYH\Models\TopOffer */
?>
...
<div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="masthead">
                    ...
                    if (!empty($topOffer->HeroImage)): ?>
                        <img src="<?php echo $topOffer->HeroImage; ?>"/>
                    <?php
                    endif;
                    ?>
                </div>
    ...
    <div class="one-brand">
                ...
                if (isset($topOffer->Tagline) || isset($providerSalePrice)) {
                    ...
                    if (!empty($topOffer->Provider->GWP->DisplayName)) {
                        ...
                        <div>
                            ...
                            <a href="<?php echo $redeemGiftUrl; ?>" class='btn btn-success full-width provider-name'>Redeem
                                Gift</a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-0">
                                <div class="price">
                                    ...
                                    <?php } ?>
                                    <a href="tel:<?php echo $this->context->Get['phoneNumber']; ?>"
                                       onClick="ga('send', 'event', 'Call', 'ClicktoCall - Bundles - CTA Banner');"
                                       class="phone-number btn btn-success btn-lg"><i
                                                class="glyphicon glyphicon-earphone"></i> <?php echo $this->context->Get['phoneNumber']; ?>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <section class='disclaimer'>
            ...
            <button type="button" class="btn btn-info btn-md pull-right" id="termsBtn">
                Terms & Conditions
            </button>
...
<div class="sticky-ticker-footer">
    CALL
    <a href="tel:<?php echo \CYH\Helpers\FormatHelper::FormatPhoneNumber($groupInfo->SpPhone); ?>"><?php echo \CYH\Helpers\FormatHelper::FormatPhoneNumber($groupInfo->SpPhone); ?></a>
    TO ORDER THIS EXCLUSIVE <?php echo $topOffer->Provider->Name; ?> DEAL
    WITH <?php echo $topOffer->Provider->GWP->DisplayName; ?> FOR <?php echo $groupInfo->Tagline; ?>
</div>
<script>
    $(function(){
