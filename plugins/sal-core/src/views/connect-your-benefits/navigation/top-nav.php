<?php
/* @var $topNavMenu \CYH\ViewModels\CYBen\TopNavMenu */
?>
<header class="page-head">
    <div class="row">
        <div class="col-md-6 logo-links">
            <a class="logo-link" href="/cyb/home?groupId=<?php echo $topNavMenu->GroupInfo->Id ?>"><img
                        src="<?php echo $topNavMenu->GroupInfo->Logo; ?>" class="brand"
                        alt="Connect Your Home&reg;"></a>
        </div>
        <div class="col-md-6 text-right">
            <?php
            do_action('\\' . \CYH\Controllers\Common\CommonUIComponents::class . '::RenderAddressSearchBox', new \CYH\ViewModels\AddressSearch('/cyb-results/?search=1', 'offer-search', ['groupId' => $topNavMenu->GroupInfo->Id]));
                ...
                <div class="menu-main-container">
                    <ul id="menu-main" class="menu">
                        ...
                        <li class="menu-item"><a
                                    href="<?php echo '/cyb/?groupId=' . $topNavMenu->GroupInfo->Id . '&salAction=logout' ?>">Log
                                Out</a></li>
                    </ul>
                </div>
            </nav>
