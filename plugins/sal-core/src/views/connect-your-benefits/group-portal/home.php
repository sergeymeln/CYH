...
<style type="text/css">
    ...
    .hero-holder-div {
        background-image: url(<?php if(!empty($groupInfo->HeroImage)) { echo $groupInfo->HeroImage; } else { echo '/wp-content/uploads/2017/09/group-default-bg.png'; }?>);
    }
...
<div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <p class="text-center mtop80">
                                        <a class="btn btn-success btn-lg" href="<?php echo \CYH\Helpers\LinkHelper::AppendQueryParams('/cyb-results?search=0', ['groupId' => $groupInfo->Id])  ?>">Get Deals</a>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <section>
        ...
        <?php
        do_action('\\' . \CYH\Controllers\ConnectYourBenefits\UIComponentsController::class . '::RenderTopOffersBlock', $topOfferFilter);
        ?>
    </section>
