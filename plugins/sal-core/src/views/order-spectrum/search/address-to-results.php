<?php/* @var $addressSearch \CYH\ViewModels\CYH\AddressSearchResults */ ?>
<header class="page-head">
    <?php do_action('\\' . \CYH\Controllers\OrderSpectrum\UIComponentsController::class . "::RenderMenu",$spInfo); ?>
</header>
<div class="results-page">
    <?php
    do_action('\CYH\Controllers\OrderSpectrum\UIComponentsController::RenderAddressSearchResultsHeaderSection', $addressSearch->Header);
